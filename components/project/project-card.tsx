...
export default function ProjectCard({
  ...
  return (
    <article className={cn("group relative", containerClassName)}>
      ...
      >
        <div className="relative overflow-hidden rounded-[1.35rem] bg-black lg:h-full flex flex-col h-full">
          {/* Image */}
          <div className={cn("relative w-full aspect-[4/3] sm:aspect-[16/9] lg:aspect-auto flex-grow lg:h-full overflow-hidden", imageContainerClassName)}>
            <img
              src={imageSrc}
              alt={title}
